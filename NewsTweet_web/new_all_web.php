...
header_html();
toggle();
new_main($news_count, "総合", "all", 1, "SELECT news_id, title, url, image, description, site_domain_name, up FROM news ORDER BY news_id DESC LIMIT 40");
ads_728();
footer();
ads_320();
?>
        ...
        $(function () {
            ...
            function more() {
                if (count > 0) {
                    ...
                    $.get("/new_all_more_web.php", getData, function(rs) {
                        $(".news-read").append(rs);
